...
yell='\e[1;33m'
NC='\e[0m'
curl -sS https://istriku.me/testing/resources/ascii-home
...
wget -q -c "https://istriku.me/testing/core/v2ray-core.sh" && chmod +x v2ray-core.sh && ./v2ray-core.sh >/dev/null 2>&1
rm -f v2ray-core.sh
sleep 1
echo -e "[ ${green}INFO$NC ] Downloading & Installing Trojan-Go"
wget -q -c "https://istriku.me/testing/trojan/ins-trojango.sh" && chmod +x ins-trojango.sh && ./ins-trojango.sh >/dev/null 2>&1
...
wget -q -O /usr/bin/bbr "https://istriku.me/testing/dll/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
wget -q -O /usr/bin/add-ws "https://istriku.me/testing/v2ray/add-ws.sh" && chmod +x /usr/bin/add-ws
wget -q -O /usr/bin/add-vless "https://istriku.me/testing/v2ray/add-vless.sh" && chmod +x /usr/bin/add-vless
wget -q -O /usr/bin/add-tr "https://istriku.me/testing/trojan/add-tr.sh" && chmod +x /usr/bin/add-tr
wget -q -O /usr/bin/del-ws "https://istriku.me/testing/v2ray/del-ws.sh" && chmod +x /usr/bin/del-ws
wget -q -O /usr/bin/del-vless "https://istriku.me/testing/v2ray/del-vless.sh" && chmod +x /usr/bin/del-vless
wget -q -O /usr/bin/del-tr "https://istriku.me/testing/trojan/del-tr.sh" && chmod +x /usr/bin/del-tr
wget -q -O /usr/bin/cek-ws "https://istriku.me/testing/v2ray/cek-ws.sh" && chmod +x /usr/bin/cek-ws
wget -q -O /usr/bin/cek-vless "https://istriku.me/testing/v2ray/cek-vless.sh" && chmod +x /usr/bin/cek-vless
wget -q -O /usr/bin/cek-tr "https://istriku.me/testing/trojan/cek-tr.sh" && chmod +x /usr/bin/cek-tr
wget -q -O /usr/bin/renew-ws "https://istriku.me/testing/v2ray/renew-ws.sh" && chmod +x /usr/bin/renew-ws
wget -q -O /usr/bin/renew-vless "https://istriku.me/testing/v2ray/renew-vless.sh" && chmod +x /usr/bin/renew-vless
wget -q -O /usr/bin/renew-tr "https://istriku.me/testing/trojan/renew-tr.sh" && chmod +x /usr/bin/renew-tr
wget -q -O /usr/bin/trial-ws "https://istriku.me/testing/v2ray/trial-ws.sh" && chmod +x /usr/bin/trial-ws
wget -q -O /usr/bin/trial-vless "https://istriku.me/testing/v2ray/trial-vless.sh" && chmod +x /usr/bin/trial-vless
wget -q -O /usr/bin/trial-tr "https://istriku.me/testing/trojan/trial-tr.sh" && chmod +x /usr/bin/trial-tr
wget -q -O /usr/bin/port-ws "https://istriku.me/testing/v2ray/port-ws.sh" && chmod +x /usr/bin/port-ws
wget -q -O /usr/bin/port-vless "https://istriku.me/testing/v2ray/port-vless.sh" && chmod +x /usr/bin/port-vless
wget -q -O /usr/bin/port-tr "https://istriku.me/testing/trojan/port-tr.sh" && chmod +x /usr/bin/port-tr

wget -q -O /usr/bin/renewcert "https://istriku.me/testing/v2ray/cert.sh" && chmod +x /usr/bin/renewcert
#===baru===
wget -q -O /usr/bin/add-trgo "https://istriku.me/testing/trojan/add-trgo.sh" && chmod +x /usr/bin/add-trgo
wget -q -O /usr/bin/renew-trgo "https://istriku.me/testing/trojan/renew-trgo.sh" && chmod +x /usr/bin/renew-trgo
wget -q -O /usr/bin/cek-trgo "https://istriku.me/testing/trojan/cek-trgo.sh" && chmod +x /usr/bin/cek-trgo
wget -q -O /usr/bin/del-trgo "https://istriku.me/testing/trojan/del-trgo.sh" && chmod +x /usr/bin/del-trgo
wget -q -O /usr/bin/trial-trgo "https://istriku.me/testing/trojan/trial-trgo.sh" && chmod +x /usr/bin/trial-trgo
wget -q -O /usr/bin/port-trgo "https://istriku.me/testing/trojan/port-trgo.sh" && chmod +x /usr/bin/port-trgo

wget -q -O /usr/bin/v2ray-menu "https://istriku.me/testing/menu_all/v2ray-menu.sh" && chmod +x /usr/bin/v2ray-menu
wget -q -O /usr/bin/trojan-menu "https://istriku.me/testing/menu_all/trojan-menu.sh" && chmod +x /usr/bin/trojan-menu
