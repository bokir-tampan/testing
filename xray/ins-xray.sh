...
wget -q -O /usr/bin/add-ws "https://istriku.me/testing/xray/add-ws.sh" && chmod +x /usr/bin/add-ws
wget -q -O /usr/bin/add-vless "https://istriku.me/testing/xray/add-vless.sh" && chmod +x /usr/bin/add-vless
wget -q -O /usr/bin/add-tr "https://istriku.me/testing/xray/add-tr.sh" && chmod +x /usr/bin/add-tr
wget -q -O /usr/bin/del-ws "https://istriku.me/testing/xray/del-ws.sh" && chmod +x /usr/bin/del-ws
wget -q -O /usr/bin/del-vless "https://istriku.me/testing/xray/del-vless.sh" && chmod +x /usr/bin/del-vless
wget -q -O /usr/bin/del-tr "https://istriku.me/testing/xray/del-tr.sh" && chmod +x /usr/bin/del-tr
wget -q -O /usr/bin/cek-ws "https://istriku.me/testing/xray/cek-ws.sh" && chmod +x /usr/bin/cek-ws
wget -q -O /usr/bin/cek-vless "https://istriku.me/testing/xray/cek-vless.sh" && chmod +x /usr/bin/cek-vless
wget -q -O /usr/bin/cek-tr "https://istriku.me/testing/xray/cek-tr.sh" && chmod +x /usr/bin/cek-tr
wget -q -O /usr/bin/renew-ws "https://istriku.me/testing/xray/renew-ws.sh" && chmod +x /usr/bin/renew-ws
wget -q -O /usr/bin/renew-vless "https://istriku.me/testing/xray/renew-vless.sh" && chmod +x /usr/bin/renew-vless
wget -q -O /usr/bin/renew-tr "https://istriku.me/testing/xray/renew-tr.sh" && chmod +x /usr/bin/renew-tr
wget -q -O /usr/bin/trial-ws "https://istriku.me/testing/xray/trial-ws.sh" && chmod +x /usr/bin/trial-ws
wget -q -O /usr/bin/trial-vless "https://istriku.me/testing/xray/trial-vless.sh" && chmod +x /usr/bin/trial-vless
wget -q -O /usr/bin/trial-tr "https://istriku.me/testing/xray/trial-tr.sh" && chmod +x /usr/bin/trial-tr
wget -q -O /usr/bin/port-ws "https://istriku.me/testing/xray/port-ws.sh" && chmod +x /usr/bin/port-ws
wget -q -O /usr/bin/port-vless "https://istriku.me/testing/xray/port-vless.sh" && chmod +x /usr/bin/port-vless
wget -q -O /usr/bin/port-tr "https://istriku.me/testing/xray/port-tr.sh" && chmod +x /usr/bin/port-tr

wget -q -O /usr/bin/renewcert "https://istriku.me/testing/xray/cert.sh" && chmod +x /usr/bin/renewcert
#===baru===
