...
wget -q -O /usr/bin/addxtls "https://istriku.me/testing/xray/add.sh" && chmod +x /usr/bin/addxtls
wget -q -O /usr/bin/delxtls "https://istriku.me/testing/xray/del.sh" && chmod +x /usr/bin/delxtls
wget -q -O /usr/bin/cekxtls "https://istriku.me/testing/xray/chk.sh" && chmod +x /usr/bin/cekxtls
wget -q -O /usr/bin/renewxtls "https://istriku.me/testing/xray/rnw.sh" && chmod +x /usr/bin/renewxtls
wget -q -O /usr/bin/portxtls "https://istriku.me/testing/xray/pxt.sh" && chmod +x /usr/bin/portxtls
